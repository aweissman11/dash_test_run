...
export const ContactForm = ({ className = "", title }: ContactFormProps) => {
  const inputClassName = "border border-border p-2 my-2 w-full";
  return (
      ...
      <div className="lg:col-span-2">
        ...
        */}
        <form method="post">
          ...
          <p>
            <button
              className="mt-2 bg-primary py-3 px-5 text-white hover:bg-primary-weak"
              type="submit"
              onClick={() =>
                // TODO: This form should be refactored to account for error handling, but is a good example of how gtag.event() can be used.
                gtag.event({
                  action: "submit",
                  category: "contact",
                  label: "form",
